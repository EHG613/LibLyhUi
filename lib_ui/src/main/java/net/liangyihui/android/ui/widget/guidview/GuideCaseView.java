...
public class GuideCaseView extends FrameLayout implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private boolean mCloseOnTouchGuideImageView;
    ...
    public GuideCaseView(Builder builder) {
        this(builder.mActivity, builder.mView, builder.mId, builder.mTitle, builder.mSpannedTitle, builder.mTitleGravity, builder.mTitleStyle, builder.mTitleSize, builder.mTitleSizeUnit,
                ...
                builder.mEnterAnimation, builder.mExitAnimation, builder.mCloseOnTouch, builder.mCloseOnTouchGuideImageView, builder.mFitSystemWindows, builder.mAdjustHeight, builder.mFocusOffSetX, builder.mFocusShape, builder.mDismissListener, builder.mRoundRectRadius,
    ...
    private GuideCaseView(Activity activity, View view, String id, String title, Spanned spannedTitle,
                          ...
                          Animation exitAnimation, boolean closeOnTouch, boolean closeOnTouchGuideImageView, boolean fitSystemWindows, int adjustHeight, int focusOffsetX,
        ...
        mCloseOnTouchGuideImageView = closeOnTouchGuideImageView;
    ...
    private void focus() {
        ...
        if (visibleView == null) {
            ...
            if (mCloseOnTouchGuideImageView) {
                imageView.setOnClickListener(view -> hide());
            }
    ...
    private void inflateCustomView(@LayoutRes int layout, OnViewInflateListener viewInflateListener) {
        ...
        ConstraintLayout.LayoutParams params = statusBar.getLayoutParams() == null ? new ConstraintLayout.LayoutParams(0, Utils.getStatusBarHeight(getContext())) : (ConstraintLayout.LayoutParams) statusBar.getLayoutParams();
    ...
    private void inflateTitleView() {
        inflateCustomView(R.layout.gcv_layout_title, view -> {
...
//                textView.setTypeface(XUI.getDefaultTypeface());
    ...
    private void inflatePicture() {
        inflateCustomView(R.layout.gcv_layout_image, view -> {
    ...
    public static class Builder {
        ...
        private boolean mCloseOnTouchGuideImageView = false;
        private boolean mFitSystemWindows;
         ...
         * @return Builder
         */
        public Builder closeOnTouchFocusView(boolean closeOnTouch) {
            mCloseOnTouchGuideImageView = closeOnTouch;
            return this;
        }
